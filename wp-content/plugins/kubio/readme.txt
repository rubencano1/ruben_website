...
= 1.6.4 =
- Documentation and other Kubio releated links update

= 1.6.3 =
- Fixed an issue where the dollar sign followed by a number in Woocommere product description was replaced with an empty string
